  ...
  return (
    <div className="w-full space-y-4">
      ...
      <button
        ...
        className={`w-full flex items-center justify-center gap-2 border-2 border-dashed rounded-2xl cursor-pointer transition-all text-slate-500 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50/30 ${
          hasFiles ? "h-12 border-slate-200" : "h-14 border-slate-200"
        }`}
      >
